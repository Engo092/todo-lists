...
function addProjectToArray(title) {
    let newProject = _factories__WEBPACK_IMPORTED_MODULE_2__["default"].project(title, ___WEBPACK_IMPORTED_MODULE_1__.projectIdNumerator.num);
    ___WEBPACK_IMPORTED_MODULE_1__["default"].push(newProject);
    ___WEBPACK_IMPORTED_MODULE_1__.projectIdNumerator.num++;
    return newProject;
};
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "projectIdNumerator": () => (/* binding */ projectIdNumerator),
/* harmony export */   "todos": () => (/* binding */ todos),
/* harmony export */   "todoIdNumerator": () => (/* binding */ todoIdNumerator)
/* harmony export */ });
...
function loadContent() {
    ...
    const project = _todoDisplay__WEBPACK_IMPORTED_MODULE_1__["default"].getTodoProject();
    for (let i = 0; i < ___WEBPACK_IMPORTED_MODULE_0__.todos.length; i++) {
        if (___WEBPACK_IMPORTED_MODULE_0__.todos[i].project == project) {
            projectContent.appendChild(_todoDisplay__WEBPACK_IMPORTED_MODULE_1__["default"].todoVisual(___WEBPACK_IMPORTED_MODULE_0__.todos[i].title, ___WEBPACK_IMPORTED_MODULE_0__.todos[i].dueDate, ___WEBPACK_IMPORTED_MODULE_0__.todos[i].priority, ___WEBPACK_IMPORTED_MODULE_0__.todos[i].id));
        };
    };
...
/* harmony import */ var _loadContent__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./loadContent */ "./src/loadContent.js");
...
const todoDisplay = (() => {
    ...
    const _inputDealer = () => {
        ...
        document.querySelector('.addTodoBtn').addEventListener('click', function() {
            if (!document.querySelector('.todoNameInput').value.replace(/\s+/g, '') == '') {
                ...
                const newTodo = _factories__WEBPACK_IMPORTED_MODULE_1__["default"].todo(project, title, desc, date, priority, ___WEBPACK_IMPORTED_MODULE_0__.todoIdNumerator.num);
                ___WEBPACK_IMPORTED_MODULE_0__.todos.push(newTodo);
                ___WEBPACK_IMPORTED_MODULE_0__.todoIdNumerator.num++;
                _removeTodoForm();
                _reloadContent();
            }
        });
    ...
    const _reloadContent = () => {
        ...
        document.querySelector('.mainContent').appendChild((0,_loadContent__WEBPACK_IMPORTED_MODULE_2__["default"])());
        todoListener();
    };

    const _removeTodo = (removedTodo) => {
        for (let i = 0; i < ___WEBPACK_IMPORTED_MODULE_0__.todos.length; i++) {
            if (___WEBPACK_IMPORTED_MODULE_0__.todos[i].id == removedTodo.id) {
                ___WEBPACK_IMPORTED_MODULE_0__.todos.splice(i, 1);
            };
        };
        _reloadContent();
    };
    ...
    const todoVisual = (title, dueDate, priority, id) => {
        ...
        if (dueDate == null) {
            ...
            todoDate.innerHTML = `${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(dueDate.split('-')), 'dd/MM/yyyy')}`
        };
...
/* harmony import */ var _todoDisplay__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./todoDisplay */ "./src/todoDisplay.js");
...
const visualDisplay = (() => {
    ...
    const _displayContent = (div) => {
        ...
        document.querySelector('.mainContent').appendChild((0,_loadContent__WEBPACK_IMPORTED_MODULE_0__["default"])(title));
        _todoDisplay__WEBPACK_IMPORTED_MODULE_4__["default"].todoListener();
    }
    ...
    const initialInboxDisplay = () => {
        ...
        document.querySelector('.mainContent').appendChild((0,_loadContent__WEBPACK_IMPORTED_MODULE_0__["default"])('Inbox'));
        _todoDisplay__WEBPACK_IMPORTED_MODULE_4__["default"].todoListener();
    };
